...
const discordId = "722481295355281439";
...
const reloadUser = async (data) => {
  ...
  <a class="discord" href="https://discord.gg/" target="_blank">Discord</a>`);
...
function showGithubRepos() {
  const getGitHubData = async () => {
    const response = await fetch(properties.github_api.baseURL + '/users/ilkayk54/repos');
...
function loadIcons() {
  ...
  $('location > a').text('Sakarya, Türkiye');
  ...
  const socials = [
    {
      ...
      href: 'https://instagram.com/ilkay.kula54',
      tippy: 'Instagram'
    },
    {
      ...
      href: 'mailto:hypercrok428@gmail.com',
      tippy: 'E-Mail'
    },
    {
    ...
    },
    {
      ...
      href: 'https://github.com/ilkayk54',
      tippy: 'GitHub'
    }
  ];
